...
namespace WeatherNet.Util.Data
{
    internal class Deserializer
    {
        public static SingleResult<CurrentWeatherResult> GetWeatherCurrent(JObject response)
        {
            ...
            {
                weatherCurrent.Title = Convert.ToString(response["weather"][0]["main"]);// Encoding.UTF8.GetString(Encoding.Default.GetBytes(Convert.ToString(response["weather"][0]["main"])));
                weatherCurrent.Description = Convert.ToString(response["weather"][0]["description"]);// Encoding.UTF8.GetString(Encoding.Default.GetBytes(Convert.ToString(response["weather"][0]["description"])));
        ...
        public static Result<FiveDaysForecastResult> GetWeatherForecast(JObject response)
        {
            ...
            foreach (var item in responseItems)
            {
                ...
                {
                    weatherForecast.Title = Convert.ToString(item["weather"][0]["main"]);// Encoding.UTF8.GetString(Encoding.Default.GetBytes(Convert.ToString(item["weather"][0]["main"])));
                    weatherForecast.Description = Convert.ToString(item["weather"][0]["description"]);// Encoding.UTF8.GetString(Encoding.Default.GetBytes(Convert.ToString(item["weather"][0]["description"])));
